...
MacProjector::setOptions ()
{
    ...
    // Print MacProjector settings
    if (m_verbose > 2)
    {
        Print() << std::format("MacProjector settings from namespace mac_proj:\n");
        Print() << std::format("verbose = {}. maxorder={}. bottom_verbose={}. maxiter={}. bottom_maxiter={}.\n", 
            m_verbose, maxorder, bottom_verbose, maxiter, bottom_maxiter);
        Print() << std::format("bottom_rtol = {}. bottom_atol={}. bottom_solver={}. num_pre_smooth={}. num_post_smooth={}\n",
            bottom_rtol, bottom_atol, bottom_solver, num_pre_smooth, num_post_smooth);
    }
    ...
    else if (bottom_solver == "hypre")
    {
	    ...
	    m_mlmg->setHypreOptionsNamespace("mac_proj.hypre");
        #else
