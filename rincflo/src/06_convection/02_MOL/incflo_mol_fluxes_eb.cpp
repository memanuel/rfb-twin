...
// *********************************************************************************************************************
#if (AMREX_USE_EB)
void mol::compute_convective_fluxes_eb (
    ...
    Geometry& geom)
{
    ...
    if ((has_extdir_or_ho_lo_x && domain_ilo >= xbx.smallEnd(0)-1) ||
        (has_extdir_or_ho_hi_x && domain_ihi <= xbx.bigEnd(0)    ) || 
        (has_extdir_or_ho_lo_y && domain_jlo >= ybx.smallEnd(1)-1) ||
        (has_extdir_or_ho_hi_y && domain_jhi <= ybx.bigEnd(1)    ) 
        #if (AMREX_SPACEDIM == 2)
        )
        #elif (AMREX_SPACEDIM == 3)
        || 
        (has_extdir_or_ho_lo_z && domain_jlo >= zbx.smallEnd(2)-1) ||
        (has_extdir_or_ho_hi_z && domain_jhi <= zbx.bigEnd(2)    ) )
        #endif
    {
    ...
    // We assume below that the stencil does not need to use hoextrap or extdir boundaries
    else 
    {
        // ****************************************************************************
        // Predict to x-faces
