...
// *********************************************************************************************************************
#if (AMREX_USE_EB)
void mol::predict_vels_on_faces_eb (
    int lev, 
    AMREX_D_DECL(
    Box const& ubx, 
    Box const& vbx, 
    ...
    Vector<Geometry> geom)
{
    ...
    if ((has_extdir_or_ho_lo_x_for_u && domain_ilo >= ubx.smallEnd(0)-1) ||
        ...
        ||
        (has_extdir_or_ho_lo_z_for_u && domain_jlo >= wbx.smallEnd(2)-1) ||
        (has_extdir_or_ho_hi_z_for_u && domain_jhi <= wbx.bigEnd(2)    ) )
        #endif
    {
        ParallelFor(Box(ubx),
        ...
        AMREX_GPU_DEVICE (int i, int j, int k) noexcept
        {
            ...
            AMREX_D_TERM(
            bool extdir_or_ho_ilo = (d_bcrec[0].lo(0) == BCType::ext_dir) || (d_bcrec[0].lo(0) == BCType::hoextrap);,
            bool extdir_or_ho_jlo = (d_bcrec[0].lo(1) == BCType::ext_dir) || (d_bcrec[0].lo(1) == BCType::hoextrap);,
            bool extdir_or_ho_klo = (d_bcrec[0].lo(2) == BCType::ext_dir) || (d_bcrec[0].lo(2) == BCType::hoextrap);)

            AMREX_D_TERM(
            bool extdir_or_ho_ihi = (d_bcrec[0].hi(0) == BCType::ext_dir) || (d_bcrec[0].hi(0) == BCType::hoextrap);,
            bool extdir_or_ho_jhi = (d_bcrec[0].hi(1) == BCType::ext_dir) || (d_bcrec[0].hi(1) == BCType::hoextrap);,
            bool extdir_or_ho_khi = (d_bcrec[0].hi(2) == BCType::ext_dir) || (d_bcrec[0].hi(2) == BCType::hoextrap);)
    ...
    if ((has_extdir_or_ho_lo_x_for_v && domain_ilo >= ubx.smallEnd(0)-1) ||
        ...
        #elif (AMREX_SPACEDIM == 3)
        ||
        (has_extdir_or_ho_lo_z_for_v && domain_jlo >= wbx.smallEnd(2)-1) ||
        (has_extdir_or_ho_hi_z_for_v && domain_jhi <= wbx.bigEnd(2)    ) )
        #endif
    {
        ParallelFor(Box(vbx),
        ...
        AMREX_GPU_DEVICE (int i, int j, int k) noexcept
        {
            ...
            AMREX_D_TERM(
            bool extdir_or_ho_ilo = (d_bcrec[1].lo(0) == BCType::ext_dir) || (d_bcrec[1].lo(0) == BCType::hoextrap);,
            bool extdir_or_ho_jlo = (d_bcrec[1].lo(1) == BCType::ext_dir) || (d_bcrec[1].lo(1) == BCType::hoextrap);,
            bool extdir_or_ho_klo = (d_bcrec[1].lo(2) == BCType::ext_dir) || (d_bcrec[1].lo(2) == BCType::hoextrap);)

            AMREX_D_TERM(
            bool extdir_or_ho_ihi = (d_bcrec[1].hi(0) == BCType::ext_dir) || (d_bcrec[1].hi(0) == BCType::hoextrap);,
            bool extdir_or_ho_jhi = (d_bcrec[1].hi(1) == BCType::ext_dir) || (d_bcrec[1].hi(1) == BCType::hoextrap);,
            bool extdir_or_ho_khi = (d_bcrec[1].hi(2) == BCType::ext_dir) || (d_bcrec[1].hi(2) == BCType::hoextrap);)
    ...
    if ((has_extdir_or_ho_lo_x_for_w && domain_ilo >= ubx.smallEnd(0)-1) ||
        ...
        #elif (AMREX_SPACEDIM == 3)
        ||
        (has_extdir_or_ho_lo_z_for_w && domain_jlo >= wbx.smallEnd(2)-1) ||
        (has_extdir_or_ho_hi_z_for_w && domain_jhi <= wbx.bigEnd(2)    ) )
        #endif
    {
        ParallelFor(Box(wbx),
        ...
        AMREX_GPU_DEVICE (int i, int j, int k) noexcept
        {
            ...
            bool extdir_or_ho_ilo = (d_bcrec[2].lo(0) == BCType::ext_dir) || (d_bcrec[2].lo(0) == BCType::hoextrap);
            bool extdir_or_ho_ihi = (d_bcrec[2].hi(0) == BCType::ext_dir) || (d_bcrec[2].hi(0) == BCType::hoextrap);

            bool extdir_or_ho_jlo = (d_bcrec[2].lo(1) == BCType::ext_dir) || (d_bcrec[2].lo(1) == BCType::hoextrap);
            bool extdir_or_ho_jhi = (d_bcrec[2].hi(1) == BCType::ext_dir) || (d_bcrec[2].hi(1) == BCType::hoextrap);

            bool extdir_or_ho_klo = (d_bcrec[2].lo(2) == BCType::ext_dir) || (d_bcrec[2].lo(2) == BCType::hoextrap);
            bool extdir_or_ho_khi = (d_bcrec[2].hi(2) == BCType::ext_dir) || (d_bcrec[2].hi(2) == BCType::hoextrap);

            if (flag(i,j,k).isConnected(0,0,-1))
            {
                // local (x,y) of centroid of z-face we are extrapolating to
                Real xf = fcz(i,j,k,0); 
                Real yf = fcz(i,j,k,1);
