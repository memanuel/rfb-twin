    ...
    BCRec const* pbc)
{
         ...
         (has_extdir_or_ho_hi_y && domain_jhi <= xebox.bigEnd(1)    ) )
    {
        ...
        [   q,ccvel,AMREX_D_DECL(domain_ilo,domain_jlo,domain_klo), AMREX_D_DECL(domain_ihi,domain_jhi,domain_khi),
