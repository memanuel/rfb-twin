    ...
    bool l_use_forces_in_trans)
{
    ...
    ParallelFor(xbx, ybx, zbx, func_xbx, func_ybx,func_zbx);
}

void godunov::predict_godunov_on_box (
    ...
    Real* p)
{
   ...
   //  BCRec const* pbc = get_velocity_bcrec_device_ptr();
    ...
    ParallelFor(
        xebox, ncomp, func_xebox,
        yebox, ncomp, func_yebox,
        zebox, ncomp, func_zebox);
    ...
    [=] AMREX_GPU_DEVICE (int i, int j, int k) noexcept
    {
        ...
        Godunov_corner_couple_zy(
            l_zylo, l_zyhi, i, j, k, n, l_dt, dy, false, zlo(i,j,k,n), zhi(i,j,k,n), q, divu, v_ad, yedge);
    ...
    [=] AMREX_GPU_DEVICE (int i, int j, int k) noexcept
    {
        ...
        Godunov_corner_couple_yz(
            l_yzlo, l_yzhi, i, j, k, n, l_dt, dz, false, ylo(i,j,k,n), yhi(i,j,k,n), q, divu, w_ad, zedge);
    ...
    [=] AMREX_GPU_DEVICE (int i, int j, int k) noexcept
    {
        ...
        Godunov_corner_couple_xz(
            l_xzlo, l_xzhi, i, j, k, n, l_dt, dz, false, xlo(i,j,k,n),  xhi(i,j,k,n), q, divu, w_ad, zedge);
    ...
    [=] AMREX_GPU_DEVICE (int i, int j, int k) noexcept
    {
        ...
        Godunov_corner_couple_zx(
            l_zxlo, l_zxhi, i, j, k, n, l_dt, dx, false, zlo(i,j,k,n), zhi(i,j,k,n), q, divu, u_ad, xedge);
    ...
    [=] AMREX_GPU_DEVICE (int i, int j, int k) noexcept
    {
        ...
        Godunov_corner_couple_yx(
            l_yxlo, l_yxhi, i, j, k, n, l_dt, dx, false, ylo(i,j,k,n), yhi(i,j,k,n), q, divu, u_ad, xedge);
