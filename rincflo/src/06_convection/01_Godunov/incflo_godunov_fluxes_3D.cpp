    ...
    bool is_velocity )
{
    ...
    else 
    {
        ...
        ParallelFor(xebox, ncomp, func_x);
        ...
        ParallelFor(yebox, ncomp, func_y);
        ...
        ParallelFor(zebox, ncomp, func_z);
    }
    ...
    [=] AMREX_GPU_DEVICE (int i, int j, int k, int n) noexcept
    {
        ...
        Godunov_corner_couple_zy(
            l_zylo, l_zyhi,i, j, k, n, l_dt, dy, iconserv[n], zlo(i,j,k,n), zhi(i,j,k,n), q, divu, vmac, yedge);
    ...
    [=] AMREX_GPU_DEVICE (int i, int j, int k, int n) noexcept
    {
        ...
        Godunov_corner_couple_yz(
            l_yzlo, l_yzhi,  i, j, k, n, l_dt, dz, iconserv[n], ylo(i,j,k,n), yhi(i,j,k,n),  q, divu, wmac, zedge);
    ...
    ParallelFor(Box(zylo), ncomp, func_zylo, Box(yzlo), ncomp, func_yzlo);
    ...
    [=] AMREX_GPU_DEVICE (int i, int j, int k, int n) noexcept
    {
        ...
        Godunov_corner_couple_zx(
            l_zxlo, l_zxhi, i, j, k, n, l_dt, dx, iconserv[n], zlo(i,j,k,n), zhi(i,j,k,n), q, divu, umac, xedge);
    ...
    [=] AMREX_GPU_DEVICE (int i, int j, int k, int n) noexcept
    {
        ...
        Godunov_corner_couple_xy(
            l_xylo, l_xyhi, i, j, k, n, l_dt, dy, iconserv[n], xlo(i,j,k,n), xhi(i,j,k,n), q, divu, vmac, yedge);
    ...
    [=] AMREX_GPU_DEVICE (int i, int j, int k, int n) noexcept
    {
        ...
        Godunov_corner_couple_yx(
            l_yxlo, l_yxhi, i, j, k, n, l_dt, dx, iconserv[n], ylo(i,j,k,n), yhi(i,j,k,n), q, divu, umac, xedge);
